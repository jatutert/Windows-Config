...
#   #######################################################################
#
Invoke-WebRequest -URI https://packages.vmware.com/tools/releases/latest/windows/x64/VMware-tools-13.0.10-25056151-x64.exe -OutFile "$env:USERPROFILE\Downloads\VMware-tools-13.0.10-25056151-x64.exe"
#
#   #######################################################################
#   Powershell 7
#   #######################################################################
