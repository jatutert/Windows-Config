...
switch ($env:COMPUTERNAME) {
    'SXN-DB-01' {
        #   Acties voor DB‑01
        #    winget install Microsoft.SQLServer.2022.Express -i
        #   winget install Microsoft.SQLServerManagementStudio.22 --force --silent --accept-package-agreements --accept-source-agreements
        winget update --all
    }
    'SXN-DC-01' {
        # Acties voor DC‑01
