...
#   27juli  38  2   Andere volgorde eerste deel en Execution Policy aanpassen
#   27juli  39  0   Google Gemini Check script Bugfixes gedaan
#   27juli  39  1   
#   27juli  39  2   
#   29juli  39  3   Active Directory User Import nieuwe naam script en CSV verwerkt in script
#
#
#   ###############################################################################
#   Vullen variabelen
...
#
#   ###############################################################################
#   Check Admin rechten huidige gebruiker
#   ###############################################################################
#
#
Write-Host "Controleer of het script met Administrator-rechten wordt uitgevoerd"
#
...
#
Write-Host "Administrator-rechten bevestigd. Script gaat verder..." -ForegroundColor Green
#
#
#   ###############################################################################
#   Initialisatie
...
#
#
#   Build 39 Update 1 Moet in deze volgorde omdat hierboven pas directory Scripts wordt aangemaakt
#
Write-Host "STAP $stappenteller A Hulpdirectories maken" -ForegroundColor Gray
Write-Log "STAP $stappenteller A Hulpdirectories maken"
#
#
#   ###########################################
...
#
#
Write-Host "STAP $stappenteller B Bepalen Windows Desktop of Windows Server" -ForegroundColor Gray
Write-Log "STAP $stappenteller B Bepalen Windows Desktop of Windows Server"
#
...
if ($osInfo.ProductType -ne 1) {
    #
    #
    Write-Host "Stap $stappenteller A Gebruiker Administrator op Windows Server vrijgeven"   -ForegroundColor Gray
    ...
    Write-Log "Stap $stappenteller B Automatische inlog aanpassen van labadmin naar administrator"
    #
    Try {
...
#
#
Write-Host "Stap $stappenteller Windows Services stoppen en ook uitschakelen om geheugen te besparen ..." -ForegroundColor Gray
Write-Log "Stap $stappenteller Windows Services stoppen en ook uitschakelen om geheugen te besparen ..."
#
...
Try { 
    ...
    #
    #   BUILD 39 Update 1 Moet in deze volgorde anders krijg je foutmelding dat NuGet er niet is
    #
...
#
#   LET OP
#   Onderstaand commando gebruikt NuGet daarom MOET installatie NuGet eerst worden gedaan
#
...
mkdir "C:\Scripts" -Force | Out-Null
Invoke-WebRequest -URI https://raw.githubusercontent.com/jatutert/Windows-Config/refs/heads/main/PS-Windows-Active-Directory/WS22-SXN-AD-DC-01-Install.ps1 -OutFile "C:\Scripts\WS22-SXN-AD-DC-01-Install.ps1" 
Invoke-WebRequest -URI https://raw.githubusercontent.com/jatutert/Windows-Config/refs/heads/main/PS-Windows-Active-Directory/WS22-SXN-AD-DC-01-Promote.ps1 -OutFile "C:\Scripts\WS22-SXN-AD-DC-01-Promote.ps1" 
Invoke-WebRequest -URI https://raw.githubusercontent.com/jatutert/Windows-Config/refs/heads/main/PS-Windows-Active-Directory/WS22-SXN-AD-DC-Import-Users-OU-Latest.ps1 -OutFile "C:\Scripts\WS22-SXN-AD-DC-Import-Users-OU.ps1" 
Invoke-WebRequest -URI https://raw.githubusercontent.com/jatutert/Windows-Config/refs/heads/main/PS-Windows-Active-Directory/WS22-SXN-DC-01-AD-Users.csv -OutFile "C:\Scripts\WS22-SXN-DC-01-AD-Users.csv" 
#
#
#   ###########################################
