...
Write-Host "Version 22" -ForegroundColor Green
...
#
#
winget install Microsoft.DotNet.DesktopRuntime.8.x86
winget install Microsoft.DotNet.DesktopRuntime.8.x64
#
#
#   ###########################################
#   WinGET VCRedist
...
Invoke-WebRequest -URI https://raw.githubusercontent.com/jatutert/Windows-Config/refs/heads/main/PS-Windows-Active-Directory/WC11-WS22-AD-Join.ps1 -OutFile "$env:USERPROFILE\Desktop\ADDS\WC11-WS22-AD-Join.ps1"
#
#
#   #######################################################################
#   Windows Server
