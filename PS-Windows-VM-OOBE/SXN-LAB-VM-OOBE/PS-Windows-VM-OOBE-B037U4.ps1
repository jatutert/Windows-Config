...
Write-Host "Version $OOBECVersion Build $OOBECBuild Update $OOBECUpdate" -ForegroundColor Green
Write-Log "Version $OOBECVersion Build $OOBECBuild Update $OOBECUpdate"
...
#
Write-Log "STAP 1 Bepalen Windows Desktop of Windows Server voltooid"
#
#
#   ###########################################
...
#
#
Write-Log "STAP 2 Hulpdiretories maken voltooid"
#
#
#   ###########################################
...
#
#
Write-Log "STAP 3 Downloaden Script naar directory Scripts voltooid"
#
#
#   ###########################################
...
if (-not (Test-Path -Path $registryPath)) {
    ...
    Catch {
        ...
        Write-Log "Installatie VMware Tools gaf een fout"
    } 
    #
}
else {
        Write-Host "[VMware Tools] Installatie is niet noodzakelijk ..." -ForegroundColor Gray
        Write-Log "[VMWare Tools] Installatie is niet noodzakelijk"
}
#
#
Write-Log "STAP 4 VMware Tools installeren voltooid"
#
#
#   ######################
...
if ($osInfo.ProductType -ne 1) {
    ...
    Write-Log "Stap 5A Gebruiker Administrator op Windows Server vrijgeven"
    #
    Try {
    ...
    Write-Log "Stap 5B Automatische inlog aanpassen van labadmin naar administrator"
    #
    Try {
...
#
#
Write-Log "STAP 5 Gebruiker Administrator vrijgeven en instellen als default gebruikers is voltooid"
#
#
#   ######################
...
Write-Log "Stap 6 Windows Services stoppen en ook uitschakelen om geheugen te besparen ..."
#
...
#
#
Write-Log "STAP 6 Windows Services uitschakelen is voltooid"
#
#
#   ######################
...
Write-Log "STAP 7 IP-Adres en DNS-instellingen aanpassen gestart"
#
#
...
#
#
Write-Log "STAP 7 IP adres instellingen aanpassen is voltooid"
#
#
#   ######################
...
Write-Log "Netwerkkaart 1 van Publiek naar Privaat zetten gestart"
#
...
Catch {
    ...
    Write-Log "Netwerkkaart 1 van Publiek naar Privaat zetten gaf een fout"
} 
#
#
Write-Log "STAP 8 NIC 1 van Public naar Private zetten is voltooid"
#
#
#   ####################
...
#
#
Write-Log "STAP 9 Windows Desktop Policies instellen is voltooid"
#
#
#   ####################
...
Write-Log "[WinGET] Installeren gestart"
#
...
#
#
Write-Log "STAP 10A WinGet Stap 1 van 2 voltooid"
#
#
#   ####################
...
Write-Log "[WinGet] Licentie activeren gestart"
#
cmd.exe /c "echo Y | winget list"
#
#
Write-Log "STAP 10B WinGet Stap B van 2 voltooid"
#
#
#   ####################
...
#
#
Write-Host "STAP 11 Installatie Runtimes met behulp van WinGet gestart" -ForegroundColor White
Write-Log "STAP 11 Installatie Runtimes met behulp van WinGet gestart"
#
#
#   ####################
...
#
#
Write-Host "Stap 11A DotNet Runtime installeren" -ForegroundColor White
Write-Log "Stap 11A DotNet Runtime installeren"
#
...
#
#
Write-Host "Stap 11B Visual C Runtime installeren" -ForegroundColor White
Write-Log "Stap 11B Visual C Runtime installeren"
#
...
#
#
Write-Log "STAP 11 Installatie Runtimes met behulp van WinGet voltooid"
#
#
#   ###########################################
...
Write-Log "STAP 12 Applicaties verwijderen Windows Desktop mbv WinGet gestart"
#
#
#   Windows Desktop
#
...
#
#
Write-Log "STAP 12 Applicaties verwijderen Windows Desktop mbv WinGet voltooid"
#
#
#   ###########################################
...
Write-Log "STAP 13 Applicaties installeren mbv Winget op Windows Desktop gestart"
#
#
#   Windows Desktop
#
...
#
#
Write-Log "STAP 13 Applicaties installeren mbv Winget op Windows Desktop voltooid"
#
#
#   ###########################################
...
Write-Log "STAP 14 Applicaties installeren mbv Winget gestart"
#
#
#   ####################
#   cURL
...
#   ###########################################
#
Write-Host "STAP 16 Powershell klaarmaken voor gebruik gestart"
Write-Log "STAP 16 Powershell klaarmaken voor gebruik gestart"
#
#
#   ###################
...
Catch {
    ...
    Write-Log "[Powershell 5] TLS Protocol versie 1.2 instellen zorgde voor een error"
} 
...
Catch {
    ...
    Write-Log "[Powershell 5] NuGet Provider en Powershell Get bijwerken is niet gelukt"
} 
...
Catch {
    ...
    Write-Log "[Powershell 5] Powershell Module Windows Update installatie is niet gelukt"
} 
...
Catch {
    ...
    Write-Log "Powershell 5 Remote Config is niet gelukt"
} 
...
Write-Log "[Powershell] Active Directory modules activeren (duurt soms erg lang) ..."
...
Write-Log "[Powershell] Help bijwerken ..."
...
#
#
Write-Log "Stap 17 Scripts downloaden is gereed"
#
#
#   ###########################################
...
if ($osInfo.ProductType -ne 1) {
    ...
    Write-Log "SSH Server installeren en configureren..."
    #
    ...
    #
    #
    Write-Log "Stap 18 Windows Server SSH en WinRM is gereed"
} 
#
#
#   ###########################################
#   ###########################################
#   Stap 19 Windows Server Firewall Poorten
#   ###########################################
#   ###########################################
#
#
...
#
#   ###################
#   Stap 19B Windows Firewall WinRM HTTP Config 
#   ###################
#
#
Try { 
    Write-Host "[Windows Firewall] WinRM HTTP configureren ..." -ForegroundColor White
    Write-Log "[Windows Firewall] WinRM HTTP configureren ..."
    Set-NetFirewallRule -Name 'WINRM-HTTP-In-TCP' -RemoteAddress Any
}
Catch {
    Write-Host "[Windows Firewall] WinRM HTTP Configuratie is niet gelukt"
    Write-Log "[Windows Firewall] WinRM HTTP Configuratie is niet gelukt"
}
#
#
Write-Log "STAP 19B Windows Firewall WinRM HTTP configuratie is voltooid"
#
#
#   ###################
#   Stap 19C Windows Firewall WinRM HTTPS Config 
#   ###################
#
#
Try {
...
Catch {
    ...
    Write-Log "[Windows Firewall] WinRM HTTPS Configuratie is niet gelukt"
} 
#
#
Write-Log "STAP 19C Windows Firewall WinRM HTTPS configuratie is voltooid"
#
#
#
#   ###########################################
#   Stap 20 Installeren Windows Updates
#   ###########################################
#
#
#   x
...
Write-Log "STAP 20 Installeren Windows Updates is voltooid"
#
#
#   ###########################################
#   Stap 21 Herstarten Virtuele machine
#   ###########################################
#
#
#   x
...
Write-Log "Herstarten virtuele machine gestart ..."
