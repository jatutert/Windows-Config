...
#
#
cmd /c "echo ======== Start OOBE Configurator by TutSOFT ========" >> c:\Scripts\VM-OOBE-LOG.txt
cmd /c "date/t" >> c:\Scripts\VM-OOBE-LOG.txt
cmd /c "time/t" >> c:\Scripts\VM-OOBE-LOG.txt
cmd /c "echo ====================================================" >> c:\Scripts\VM-OOBE-LOG.txt
#
#
#   #######################################################################
#   Alle Windows 
...
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 1 Bepalen Windows Desktop of Windows Server voltooid"
#
#
#   ###########################################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 2 Hulpdiretories maken voltooid"
#
#
#   ###########################################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 3 Downloaden Script naar directory Scripts voltooid"
#
#
#   ###########################################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 4 VMware Tools installeren voltooid"
#
#
#   ######################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 5 Gebruiker Administrator vrijgeven en instellen als default gebruikers is voltooid"
#
#
#   ######################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 6 Windows Services uitschakelen is voltooid"
#
#
#   ######################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 7 IP adres instellingen aanpassen is voltooid"
#
#
#   ######################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 8 NIC 1 van Public naar Private zetten is voltooid"
#
#
#   ####################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 9 Windows Desktop Policies instellen is voltooid"
#
#
#   ####################
...
#
#
cmd /c "echo Stap 17 Scripts downloaden is gereed >> c:\Scripts\VM-OOBE-LOG.txt
#
#
#   ###########################################
...
if ($osInfo.ProductType -ne 1) {
    ...
    #
    #
    cmd /c "echo Stap 18 Windows Server SSH en WinRM is gereed" >> c:\Scripts\VM-OOBE-LOG.txt
} 
#
#
#   ###########################################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 19B Windows Firewall WinRM HTTP configuratie is voltooid"
#
#
#   ###################
...
#
#
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 19C Windows Firewall WinRM HTTPS configuratie is voltooid"
#
#
#
#   ###########################################
...
Add-Content -Path C:\Scripts\VM-OOBE-LOG.txt -Value "STAP 20 Installeren Windows Updates is voltooid"
#
#
#   ###########################################
